...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-03-2024 a las 19:24:30
...
CREATE TABLE `table_flota` (
  ...
  `id_unidad` varchar(20) COLLATE utf8mb4_spanish_ci NOT NULL,
  `marca_unidad` varchar(20) COLLATE utf8mb4_spanish_ci NOT NULL,
  `modelo_unidad` varchar(20) COLLATE utf8mb4_spanish_ci NOT NULL,
  `vim_unidad` varchar(20) COLLATE utf8mb4_spanish_ci NOT NULL,
  `fecha_creacion` varchar(20) COLLATE utf8mb4_spanish_ci NOT NULL,
  `cap_pasajero` int(11) NOT NULL,
  `tipo_combustible` varchar(20) COLLATE utf8mb4_spanish_ci NOT NULL,
...
(3, 'BY-08', 'YUTONG', 'ZK6896HGA', 'LZYTDGD63E1000735', '2014', 25, 'Diesel', 0),
(4, 'BY-10', 'YUTONG', 'ZK6896HGA', 'LZYTDGD65E1000770', '2014', 25, 'Diesel', 1),
(5, 'BY-11', 'YUTONG', 'ZK6118HGA', 'LZYTAGE67E1001510', '2014', 44, 'G.L.P', 1),
...
(9, 'BY-18', 'YUTONG', 'ZK6118HGA', 'LZYTAGE64E1001514', '2014', 44, 'G.L.P', 1),
...
(15, 'BY-28', 'YUTONG', 'ZK6118HGA', 'LZYTAGE60E1004331', '2014', 44, 'G.L.P', 1),
...
(26, 'BY-44', 'YUTONG', 'ZK6896HGA', 'LZYTDGD60F1001228', '2015', 25, 'Diesel', 1),
(27, 'BY-48', 'YUTONG', 'ZK6896HGA', 'LZYTDGD6XF1001091', '2015', 25, 'Diesel', 1),
(28, 'BY-49', 'YUTONG', 'ZK6896HGA', 'LZYTDGD67F1001193', '2015', 25, 'Diesel', 1),
(29, 'BY-50', 'YUTONG', 'ZK6896HGA', 'LZYTDGD69F1001244', '2015', 25, 'Diesel', 1),
...
(35, 'BY-57', 'YUTONG', 'ZK6752D', 'LZYTETD27F1014884', '2016', 30, 'Diesel', 1),
...
(39, 'BY-62', 'YUTONG', 'ZK6118HGA', 'LZYTAGE65G1000990', '2016', 44, 'Diesel', 1),
(40, 'BY-63', 'YUTONG', 'ZK6118HGA', 'LZYTAGE6XG1000967', '2016', 44, 'Diesel', 1),
(41, 'BY-64', 'YUTONG', 'ZK6118HGA', 'LZYTAGE61G1000954', '2016', 44, 'Diesel', 1),
(42, 'BY-65', 'YUTONG', 'ZK6118HGA', 'LZYTAGE69G1001009', '2016', 44, 'Diesel', 1),
...
(65, 'BY-89', 'YUTONG', 'ZK6118HGA', 'LZYTAGE63G1007257', '2016', 44, 'Diesel', 1),
(66, 'BY-90', 'YUTONG', 'ZK6118HGA', 'LZYTAGE64G1007350', '2016', 44, 'Diesel', 1),
(67, 'BY-91', 'YUTONG', 'ZK6118HGA', 'LZYTAGE68G1007318', '2016', 44, 'Diesel', 1),
(68, 'BY-92', 'YUTONG', 'ZK6118HGA', 'LZYTAGE66G1007284', '2016', 44, 'Diesel', 1),
(69, 'BY-94', 'YUTONG', 'ZK6118HGA', 'LZYTAGE64G1007316', '2016', 44, 'Diesel', 1),
(70, 'BY-95', 'YUTONG', 'ZK6118HGA', 'LZYTAGE68G1007352', '2016', 44, 'Diesel', 1),
...
(76, 'BY-101', 'YUTONG', 'ZK6118HGA', 'LZYTAGE63G1007310', '2016', 44, 'Diesel', 1),
...
(115, 'BY-001', 'YUTONG', 'ZK6896HGA', 'LZYTDGD66G1009383', '2016', 25, 'Diesel', 0),
(116, 'BY-002', 'YUTONG', 'ZK6896HGA', 'LZYTDGD65G1009326', '2016', 25, 'Diesel', 0),
...
(147, 'sd', 'YUTONG', 'ZK6896HGA', 'ererwe', '2015', 23, 'disel', 0);
...
CREATE TABLE `table_user` (
  ...
  `user_pass` text COLLATE utf8_spanish_ci DEFAULT NULL,
  ...
  `user_img` text COLLATE utf8_spanish_ci DEFAULT NULL,
  `user_registro` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `user_ruta` text COLLATE utf8_spanish_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
(1, 2000000, 'ADMIN', 'OCs4Z1hFT083MklFOU15V1NpMS9jdz09', 'Admin', 'Admin', 'admin@admin', '5555555555', 1, 1, 'default.png', '2024-03-02 01:32:03', 'system/app/Views/Docs/AUN-01/'),
...
CREATE TABLE `v_timeline` (
  `login` varchar(50) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  ...
  `fecha` varchar(20) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `inicio` varchar(20) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `fin` varchar(20) COLLATE utf8mb4_spanish_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
